...
use app\modules\dashboard\models\Beneficiary as BeneficiaryModel;

/**
 * Beneficiary represents the model behind the search form of `app\modules\dashboard\models\Beneficiary`.
 */
