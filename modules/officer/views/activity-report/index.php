                                                ...
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item has-icon" href="<?= Url::to(['/officer/activity/report-view', 'id' => $activityReport->id]) ?>">
                                                                <i class="feather-eye"></i> View
                                                            </a>
                                                            <?php if ($activityReport->activity->status == 10) { ?>

                                                                <a class="dropdown-item has-icon" href="<?= Url::to(['/officer/activity/report-update', 'id' => $activityReport->id]) ?>">
                                                                    <i class="feather-edit"></i> Update
                                                                </a>
                                                                <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/officer/activity/report-delete', 'id' => $activityReport->id]) ?>">
