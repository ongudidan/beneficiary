                        ...
                        <div class="col-auto text-end float-end ms-auto download-grp">
                            <p>
                                <?php if (Yii::$app->controller->id === 'activity-report') { ?>
                                    <a href="<?= Url::to(['/coordinator/activity-report/update', 'id' => $model->id]) ?>" class="btn btn-sm bg-danger-light">
                                        <i class="feather-edit"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm bg-danger-light delete-btn" data-url="<?= Url::to(['/coordinator/activity-report/delete', 'id' => $model->id]) ?>">
