...
/**
 * FieldOfficerearch represents the model behind the search form of `app\modules\dashboard\models\FieldOfficer`.
 */
class FieldOfficerearch extends FieldOfficer
{
    /**
     * {@inheritdoc}
     */
