...
use app\modules\ambassador\models\ActivityReport;
...
/** @var app\modules\ambassador\models\ActivityReportSearch $searchModel */
...
<div class="activity-report-index">
    ...
    <div class="product-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/ambassador/activityReport/index']) ?>">
                <div class="row">
                                ...
                                ?>
                                    <?php foreach ($dataProvider->getModels() as $index => $activityReport): ?>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions ">
                                                    <a href="<?= Url::to(['/ambassador/activity-report/view', 'id' => $activityReport->id]) ?>" class="btn btn-sm bg-success-light me-2 ">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="<?= Url::to(['/ambassador/activity-report/update', 'id' => $activityReport->id]) ?>" class="btn btn-sm bg-danger-light">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm bg-danger-light delete-btn" data-url="<?= Url::to(['/ambassador/activity-report/delete', 'id' => $activityReport->id]) ?>">
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item has-icon" href="<?= Url::to(['/ambassador/activity/report-view', 'id' => $activityReport->id]) ?>">
                                                                <i class="feather-eye"></i> View
                                                            </a>
                                                            <?php if ($activityReport->activity->status == 10) { ?>

                                                                <a class="dropdown-item has-icon" href="<?= Url::to(['/ambassador/activity/report-update', 'id' => $activityReport->id]) ?>">
                                                                    <i class="feather-edit"></i> Update
                                                                </a>
                                                                <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/ambassador/activity/report-delete', 'id' => $activityReport->id]) ?>">
                                            ...
                                            <?php } elseif (Yii::$app->controller->action->id === 'index') { ?>
