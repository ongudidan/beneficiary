...
/** @var app\modules\dashboard\models\AuthAssignmentSearch $searchModel */
...
<div class="auth-assignment-index">
    ...
    <div class="product-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/dashboard/auth-assignment/index']) ?>">
                <div class="row">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/dashboard/auth-assignment/create') ?>" class="btn btn-primary"><i
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/dashboard/auth-assignment/view', 'item_name' => $authAssignment->item_name, 'user_id' => $authAssignment->user_id]) ?>">
                                                            <i class="feather-eye"></i> View
                                                        </a>
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/dashboard/auth-assignment/update', 'item_name' => $authAssignment->item_name, 'user_id' => $authAssignment->user_id]) ?>">
                                                            <i class="feather-eye"></i> Update
                                                        </a>
                                                        <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/dashboard/auth-assignment/delete', 'item_name' => $authAssignment->item_name, 'user_id' => $authAssignment->user_id]) ?>">
