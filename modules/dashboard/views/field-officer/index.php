...
/** @var app\modules\dashboard\models\FieldOfficerSearch $searchModel */
...
<div class="field-officer-index">
    ...
    <div class="product-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/dashboard/field-officer/index']) ?>">
                <div class="row">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/dashboard/field-officer/create') ?>" class="btn btn-primary"><i
                                ...
                                ?>
                                    <?php foreach ($dataProvider->getModels() as $index => $field_officer): ?>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions ">
                                                    <a href="<?= Url::to(['/dashboard/field-officer/view', 'id' => $field_officer->id]) ?>" class="btn btn-sm bg-success-light me-2 ">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="<?= Url::to(['/dashboard/field-officer/update', 'id' => $field_officer->id]) ?>" class="btn btn-sm bg-danger-light">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm bg-danger-light delete-btn" data-url="<?= Url::to(['/dashboard/field-officer/delete', 'id' => $field_officer->id]) ?>">
