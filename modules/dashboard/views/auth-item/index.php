...
/** @var app\modules\dashboard\models\AuthItemSearch $searchModel */
...
<div class="auth-item-index">
    ...
    <div class="product-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/dashboard/auth-item/index']) ?>">
                <div class="row">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/dashboard/auth-item/create') ?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php if ($dataProvider->getCount() > 0): ?>
                                    <?php foreach ($dataProvider->getModels() as $index => $authItem): ?>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="<?= Url::to(['/dashboard/auth-item/view', 'name' => $authItem->name]) ?>" class="btn btn-sm bg-success-light me-2">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="<?= Url::to(['/dashboard/auth-item/update', 'name' => $authItem->name]) ?>" class="btn btn-sm bg-danger-light">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm bg-danger-light delete-btn" data-url="<?= Url::to(['/dashboard/auth-item/delete', 'name' => $authItem->name]) ?>">
