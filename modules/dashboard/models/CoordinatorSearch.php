...
/**
 * CoordinatorSearch represents the model behind the search form of `app\modules\dashboard\models\Coordinator`.
 */
class CoordinatorSearch extends Coordinator
{
    ...
    {
        return [
            [['id', 'name', 'user_id', 'national_id', 'email', 'phone_no', 'created_by', 'updated_by'], 'safe'],
